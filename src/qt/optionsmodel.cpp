...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::yaadi);
    ...
    if (!settings.contains("nAnonymizeyaadiAmount"))
        settings.setValue("nAnonymizeyaadiAmount", 1000);

    nAnonymizeyaadiAmount = settings.value("nAnonymizeyaadiAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeyaadiAmount"))
        SoftSetArg("-anonymizeyaadiamount", settings.value("nAnonymizeyaadiAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in yaadi.cpp during shotdown to also remove the window positions
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizeyaadiAmount:
            return QVariant(nAnonymizeyaadiAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizeyaadiAmount:
            nAnonymizeyaadiAmount = value.toInt();
            settings.setValue("nAnonymizeyaadiAmount", nAnonymizeyaadiAmount);
            emit anonymizeyaadiAmountChanged(nAnonymizeyaadiAmount);
            break;
        case CoinControlFeatures:
