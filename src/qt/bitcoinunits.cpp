...
QString BitcoinUnits::id(int unit)
{
    ...
    case yaadi:
        return QString("YAAD");
    case mECA:
        return QString("mYAAD");
    case uECA:
        return QString::fromUtf8("uYAAD");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case yaadi:
            return QString("tYAAD");
        case mECA:
            return QString("mtYAAD");
        case uECA:
            return QString::fromUtf8("YAAD");
        default:
            return QString("???");
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case yaadi:
            return QString("YAAD");
        case mECA:
            return QString("Milli-YAAD (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-YAAD (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case yaadi:
            return QString("TestYAAD");
        case mECA:
            return QString("Milli-TestYAAD (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestYAAD (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
