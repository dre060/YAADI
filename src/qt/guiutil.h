...
/** Utility functions used by the yaadi Qt UI.
 */
namespace GUIUtil
{
...
// Render yaadi addresses in monospace font
...
// Parse "yaadi:" URI into recipient object, return true on successful parsing
