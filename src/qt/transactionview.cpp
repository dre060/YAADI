 ...
 */
    ...
    typeWidget->addItem(tr("Received yaadi from zyaadi"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zyaadi"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEca));
