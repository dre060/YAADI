                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("YAADI Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&yaadi Project"), this);
    webmainAction->setStatusTip(tr("yaadi Project Website"));
    ...
    facebookAction->setStatusTip(tr("yaadi Facebook"));
    ...
    twitterAction->setStatusTip(tr("yaadi Twitter"));
    ...
    discordAction->setStatusTip(tr("yaadi Discord"));
    ...
    youtubeAction->setStatusTip(tr("yaadi Youtube"));
    ...
    telegramAction->setStatusTip(tr("yaadi Telegram"));
    ...
    redditAction->setStatusTip(tr("yaadi Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap yaadi"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell yaadi Coin (yaadi)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    yaadiBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&yaadi block explorer"), this);
    yaadiBlockExplorerAction->setStatusTip(tr("yaadi blockchain explorer"));
    yaadiBlockExplorerAction->setToolTip(yaadiBlockExplorerAction->statusTip());
    yaadiBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&yaadi Project Github"), this);
    githubAction->setStatusTip(tr("yaadi Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a yaadi address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and yaadi: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zyaadi"));
...
//    }
    ...
    connect(yaadiBlockExplorerAction, SIGNAL(triggered()), this, SLOT(yaadiBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About yaadi Core"), this);
    aboutAction->setStatusTip(tr("Show information about yaadi Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for yaadi"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your yaadi addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified yaadi addresses"));
    ...
    openAction->setStatusTip(tr("Open a yaadi: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the yaadi Core help message to get a list with possible yaadi command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(yaadiBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("yaadi Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.yaadi.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/yaadi.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/yaadi4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/yaadicryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/yaadi-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::yaadiBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/yaadi/yaadi/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to yaadi network", "", count));
}
...
{
    QString strTitle = tr("yaadi Core"); // default title
