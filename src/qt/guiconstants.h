...
/* yaadi GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "yaadi"
#define QAPP_ORG_DOMAIN "yaadiproject.org"
#define QAPP_APP_NAME_DEFAULT "yaadi-Qt"
#define QAPP_APP_NAME_TESTNET "yaadi-Qt-testnet"
