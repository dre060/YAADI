...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* yaadi features */
        {"yaadi", "masternode", &masternode, true, true, false},
        {"yaadi", "listmasternodes", &listmasternodes, true, true, false},
        {"yaadi", "getmasternodecount", &getmasternodecount, true, true, false},
        {"yaadi", "masternodeconnect", &masternodeconnect, true, true, false},
        {"yaadi", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"yaadi", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"yaadi", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"yaadi", "masternodecurrent", &masternodecurrent, true, true, false},
        {"yaadi", "masternodedebug", &masternodedebug, true, true, false},
        {"yaadi", "startmasternode", &startmasternode, true, true, false},
        {"yaadi", "createmasternodekey", &createmasternodekey, true, true, false},
        {"yaadi", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"yaadi", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"yaadi", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"yaadi", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"yaadi", "getmasternodescores", &getmasternodescores, true, true, false},
        {"yaadi", "mnbudget", &mnbudget, true, true, false},
        {"yaadi", "preparebudget", &preparebudget, true, true, false},
        {"yaadi", "submitbudget", &submitbudget, true, true, false},
        {"yaadi", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"yaadi", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"yaadi", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"yaadi", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"yaadi", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"yaadi", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"yaadi", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"yaadi", "checkbudgets", &checkbudgets, true, true, false},
        {"yaadi", "mnsync", &mnsync, true, true, false},
        {"yaadi", "spork", &spork, true, true, false},
        {"yaadi", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> yaadi-cli " + methodname + " " + args + "\n";
}
