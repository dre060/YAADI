...
public:
    CMainParams()
    {
        ...
        nEnforceNewSporkKey = 1525158000;                           // Sporks signed after (yaadi): Tuesday, May 1, 2018 7:00:00 AM yaadi must use the new spork key
        nRejectOldSporkKey = 1527811200;                            // Fully reject old spork key after (yaadi): Friday, June 1, 2018 12:00:00 AM

        const char* pszTimestamp = "yaadi is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1622855354;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 4816507;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x95d0674745581903791327fc01e7212b3d5bcd136a5fb5ffaef3127bdc5693ae"));
        assert(hashGenesisBlock == uint256("0x00000fb56e0ac6d4cf8da7cffea78c9fabec985f4cb032a74266bf746c509ac9"));

     
		
	vSeeds.push_back(CDNSSeedData("144.202.16.100","144.202.16.100"));
        ...
        nStartMasternodePayments = 1403728576; //Wed, 25 Jun 2014 20:36:16 yaadi
...
public:
    CTestNetParams()
    {
        ...
        nModifierUpdateBlock = -1; //approx Mon, 17 Apr 2017 04:00:00 yaadi
        ...
        nBlockZerocoinV2 = nZerocoinStartHeight + 20; //!> The block that zerocoin v2 becomes active
        nEnforceNewSporkKey = 1521604800; //!> Sporks signed after Wednesday, March 21, 2018 4:00:00 AM yaadi must use the new spork key
        nRejectOldSporkKey = 1522454400; //!> Reject old spork key after Saturday, March 31, 2018 12:00:00 AM yaadi

        //! Modify the testnet genesis block so the timestamp is valid for a later start.
        genesis.nTime = 1612138687;
        genesis.nBits = bnProofOfWorkLimit.GetCompact(); //0x1f00ffff;
        genesis.nNonce = 1030659;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x95d0674745581903791327fc01e7212b3d5bcd136a5fb5ffaef3127bdc5693ae"));
        assert(hashGenesisBlock == uint256("0x00009bbecf0011e329c5b7aa4938280b495b898a3cb92248fd1106ca71deeff7"));
        ...
        nStartMasternodePayments = 1420837558; //Fri, 09 Jan 2015 21:05:58 yaadi
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x95d0674745581903791327fc01e7212b3d5bcd136a5fb5ffaef3127bdc5693ae"));
        assert(hashGenesisBlock == uint256("0x5689f27d94ce976dc75c2cbb7a0d65c6e401ec19ef372863424431687e950458"));
