...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("yaadi yaadi-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  yaadi-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yaadi transaction") + "\n" +
                               "  yaadi-tx [options] -create [commands]   " + _("Create hex-encoded yaadi transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded yaadi transaction
