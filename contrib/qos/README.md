...
This means one can have an always-on yaadid instance running, and another local yaadid/yaadi-qt instance which connects to this node and receives blocks from it.
