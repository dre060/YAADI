...
RESOURCES += src/qt/yaadi.qrc src/qt/yaadi_locale.qrc

TRANSLATIONS += src/qt/locale/yaadi_bg.ts \
                src/qt/locale/yaadi_de.ts \
                src/qt/locale/yaadi_en.ts \
                src/qt/locale/yaadi_es.ts \
                src/qt/locale/yaadi_fi.ts \
                src/qt/locale/yaadi_fr.ts \
                src/qt/locale/yaadi_it.ts \
                src/qt/locale/yaadi_ja.ts \
                src/qt/locale/yaadi_pl.ts \
                src/qt/locale/yaadi_pt.ts \
                src/qt/locale/yaadi_ru.ts \
                src/qt/locale/yaadi_sk.ts \
                src/qt/locale/yaadi_sv.ts \
                src/qt/locale/yaadi_vi.ts \
                src/qt/locale/yaadi_zh_CN.ts \
                src/qt/locale/yaadi_zh_TW.ts
