Contributing to yaadi Core
============================

The yaadi Core project operates an open contributor model where anyone is
...
The following applies to code changes to the yaadi Core project, and is not to be
confused with overall yaadi Network Protocol consensus changes.

Whether a pull request is merged into yaadi Core rests with the project merge
...
Patches that change yaadi consensus rules are considerably more involved than
...
Where a patch set proposes to change the yaadi consensus, it must have been
...
The project leader is the release manager for each yaadi Core release.
