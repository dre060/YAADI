...
In order to support loading of multiple wallets in yaadi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is yaadi.cpp.
...
Changes to yaadi.cpp
----------------------
yaadi.cpp is the entry point into yaadi-qt, and as such, will require some minor modifications to provide hooks for
